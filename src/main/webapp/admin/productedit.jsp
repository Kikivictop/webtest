                    ...
                    <div class='row-fluid'>
                        <div class='span12 box'>
                            ...
                            <div class='box-content'>
                                <form accept-charset="UTF-8" action="productEdit?pageNum=${pageNum}" class="form" method="post" style="margin-bottom: 0;" /><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" /></div>
                                ...
                                <div class='control-group'>
                                    <label class='control-label' for='addr'>产地</label>
                                    <div class='controls'>
                                        <input   name="addr" id="addr" value="${product.addr}" placeholder='产地' class='span5' type='text'  required oninvalid="setCustomValidity('产地不能为空')" oninput="setCustomValidity('');"/>
                                    </div>
                                </div>
